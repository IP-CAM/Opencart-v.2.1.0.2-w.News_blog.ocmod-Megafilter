    ...
    <div class="container">
        <div id="product" class="kart-content">
                    ...
                    <?php if ($images) { ?>
                        <div class="kart-left_slider">
                            <?php foreach ($images as $image) { ?>
                                <div class="kart-left_slider-inner"><img src="<?php echo $image['thumb']; ?>"
            ...
            <div class="kart-right">
                <div class="kart-right_title">
                    <h1>  <?php echo $heading_title; ?></h1>
                </div>

                <div class="kart-right_links">

                    <div class="kart-right_links_reviews">
                        <ul>
                            <?php for ($i = 1; $i <= 5; $i++) { ?>
                                <?php if ($rating < $i) { ?>
                                    <li></li>
                ...
                <div class="kart-right_about-prod">
                    <?php foreach ($attribute_groups as $attribute_group) { ?>
                        <?php foreach ($attribute_group['attribute'] as $attribute) { ?>
                            <div class="kart-right_about-prod_item">
                                <div class="kart-right_about-prod_item_title"><?php echo $attribute['name']; ?></div>
                                <div class="kart-right_about-prod_item_text"><?php echo $attribute['text']; ?></div>
                            </div>
                        <?php } ?>
                    <?php } ?>
            ...
            <div class="kart-right_buy-btn">
                <div class="kart-right_buy-btn_select">
                    <div class="kart-right_buy-btn_select_title"><label class="control-label"
            ...
            <div class="prod-slider">
                <div class="prod-iner">
                    <?php foreach ($products as $product) { ?>
                        <div class="prod-item">
                            <div class="prod-img"><a href="<?php echo $product['href']; ?>"><img
                            ...
                            <div class="prod-price"><a
                                        href="<?php echo $product['href']; ?>"><?php echo $product['price']; ?></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
    ...
    <form class="form-horizontal" id="form-review">
        ...
        <?php if ($review_guest) { ?>
            ...
            <div class="buttons clearfix">
                ...
                <div class="kart-right_buy-btn">
                    <button type="button" id="button-review" data-loading-text="<?php echo $text_loading; ?>" class="default-btn buy-one-click"><?php echo $button_continue; ?></button>
                </div>
                    ...
                    <div class="<?php echo $class; ?>">
                        ...
                        <?php if ($price) { ?>
                            <ul class="list-unstyled">
                                ...
                                <?php } else { ?>
                                    <li><span style="text-decoration: line-through;"><?php echo $price; ?>HUI</span>
                                    </li>
                                    <li>
